...
namespace CForge {
	...
	CrossForgeException::CrossForgeException(Type T, const std::string Message, const std::string Info01, const std::string Info02, const std::string File, const int32_t Line, const std::string Function) {
		m_Message = Message;
		m_File = File;
		m_Line = Line;
		m_Function = Function;
